...
def download_audio_file(asset_num, bird_name):
    ...
    output_path = f"./dataset/audio/{bird_name}/{asset_num}_cornell.wav"
    ...
    if response.status_code == 200:
        ...
        clean.reduce_noise(output_path, f"./clean/{bird_name}/{asset_num}_cornell.wav")
